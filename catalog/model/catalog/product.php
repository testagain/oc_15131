...
class ModelCatalogProduct extends Model {
	...
	public function getTotalProductLatest($data){
		
		$query = $this->db->query("SELECT COUNT(DISTINCT p.product_id) AS total FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) LEFT JOIN " . DB_PREFIX . "product_to_store p2s ON (p.product_id = p2s.product_id)");
	...
	public function getProductLatest($data){
	...
	public function getTotalProductBestseller($data){
	...
	public function getTotalProductFeatured($data) {
		
		$query = $this->db->query("SELECT COUNT(DISTINCT p.product_id) AS total FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) LEFT JOIN " . DB_PREFIX . "product_to_store p2s ON (p.product_id = p2s.product_id) WHERE p.is_featured = 1 ");
	...
	public function getProductFeatured($data){
